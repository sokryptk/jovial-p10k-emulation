# Generated by Powerlevel10k configuration wizard on 2020-05-08 at 15:39 IST.
...
# darkest-ornaments, sparse, fluent, instant_prompt=quiet.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION='%f➤'
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%81F'   # blue foreground
  ...
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%F{49}[%m] %fas %F{49}%n %fin'
